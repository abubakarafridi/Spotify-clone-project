...
async function displayAlbums() {
  let a = await fetch(`https://github.com/abubakarafridi/Spotify-clone-project/tree/main/songs`);
  let response = await a.text();
  let div = document.createElement('div');
  div.innerHTML = response;
  ...
  for (let index = 0; index < array.length; index++) {
    ...
    if (e.href.includes('/songs/')) {
      ...
      let a = await fetch(`https://github.com/abubakarafridi/Spotify-clone-project/tree/main/songs/${folder}/info.json`);
